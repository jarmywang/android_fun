...
import com.example.user.myapplication.slidingcard_core.ContainerView;
import com.example.user.myapplication.slidingcard_core.SlidingCard;
...
public class MainActivity extends AppCompatActivity implements ContainerView.ContainerInterface {
    ...
    private void initData() {
        ...
        contentView.initCardView(this, R.layout.sliding_card_item, R.id.sliding_card_content_view);
    }
